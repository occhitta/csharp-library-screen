...
public sealed class ConfirmDialogData(string headerText, object detailData) : AbstractScreenData {
	#region メンバー変数定義
	/// <summary>
	/// 表題内容
	/// </summary>
	...
	/// 保留操作
	/// </summary>
	private DelegateScreenLightHook? retainMenu = null;
	/// <summary>
	/// 選択情報
	/// </summary>
	private bool? selectData = null;
	/// <summary>
	/// 通知一覧
	/// </summary>
	...
	/// </summary>
	/// <value>保留操作</value>
	public AbstractScreenLightHook RetainMenu => this.retainMenu ??= new DelegateScreenLightHook(ActionRetainMenu);
	/// <summary>
	/// 選択情報を取得します。
	/// </summary>
	/// <value>選択情報</value>
	...
	#region 内部メソッド定義(画面操作関連:ActionAcceptMenu/ActionCancelMenu/ActionIgnoreMenu)
	/// <summary>
	/// 許可操作を実行します。
	/// </summary>
	...
	/// 保留操作を実行します。
	/// </summary>
	private void ActionRetainMenu() {
		SelectData = null;
		this.selectHook?.Invoke(this, EventArgs.Empty);
	}
	#endregion 内部メソッド定義(画面操作関連:ActionAcceptMenu/ActionCancelMenu/ActionIgnoreMenu)
}
